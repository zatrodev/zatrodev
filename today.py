...
HEADERS = {"authorization": "token " + os.environ["PERSONAL_TOKEN"]}
USER_NAME = "zatrodev"
QUERY_COUNT = {
    "user_getter": 0,
    "follower_getter": 0,
...
if __name__ == "__main__":
    """
    Roberto Neil Santos (zatrodev), 2022-2025
    """
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2004, 11, 16))
